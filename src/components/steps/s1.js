                ...
                <div className="question">
                    <div className="col-md-8">
                        <div className="question-title">
                            Do you require iOS builds on non-Mac devices?
                        </div>
                    ...
                    <div className="note col-md-4">
                        While Android applications can be built on any desktop OS, projects for iPhones and iPads require
                        compilation on a Mac device. Some tools (like Aquro, Codename One, Smartface and ViziApps) remove
        ...
        if(this.state.windowsPhone && !this.state.windows){
            return (
                <div className="question">
                    <div className="col-md-8">
                        <div className="question-title">
                            Do you require Windows builds on non-Windows desktop devices?
                        </div>
                        <div className="answers col-md-10 col-md-offset-2">
                            <input type="radio"
                                   name="winNonWin"
                    ...
                    <div className="note col-md-4">
                        Similar to iOS, also Windows mobile requires builds on a Windows desktop machine. Unlike macOS,
        ...
        return (
            <div>
                ...
                <div className="question">
                    <div className="col-md-8">
                        <div className="question-title">
                            Which mobile operating systems do you want to target?
                        </div>
                        <div className="answers col-md-10 col-md-offset-2">
                            <input type="checkbox"
                    ...
                    <div className="note col-md-4">
                        The obvious question is for which operating systems will the application be developed. All tools
                ...
                <div className="question">
                    <div className="col-md-8">
                        <div className="question-title">
                            Which desktop operating systems do you have available for development?
                        </div>
                        <div className="answers col-md-10 col-md-offset-2">
                            <input type="checkbox"
                    ...
                    <div className="note col-md-4">
                        Most tools can be installed both on Mac and Windows desktops, while a bit smaller portion
                ...
                <div className="question">
                    <div className="col-md-8">
                        <div className="question-title">
                            What is the size of your team? How much are you willing to pay? Note: prices are state per
                            developer per year.
                        </div>
                        <div className="answers col-md-10 col-md-offset-2">
                            <input type="radio"
                    ...
                    <div className="note col-md-4">
                        Most licences and subscriptions are based on the size of the development team. Individuals or
